...
class CartManager {
    ...
    updateTotals() {
        ...
        this.cart.total = this.cart.subtotal; // Убрали налог
    }
    ...
    updateCartDisplay() {
        ...
        // Update totals
        document.querySelector('.subtotal-amount').textContent = `${this.cart.subtotal.toFixed(2)}р`;
        document.querySelector('.total-amount').textContent = `${this.cart.total.toFixed(2)}р`;
    } 
    ...
    createCartItemElement(item) {
        ...
        itemElement.querySelector('.cart-item-price').textContent = `${(item.price * item.quantity).toFixed(2)}р`;
